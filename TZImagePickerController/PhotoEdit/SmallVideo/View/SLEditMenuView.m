...
- (void)createSubmenu {
    ...
    NSArray *colors = @[[UIColor redColor], [UIColor blackColor], [UIColor whiteColor], [UIColor yellowColor], [UIColor greenColor], [UIColor cyanColor], [UIColor purpleColor], [UIColor clearColor]];
...
- (void)createSubmenu {
    ...
    NSArray *imageNames = @[@"EditMenuMosaic", @"EditMenuGraffitiBack"];
    NSArray *imageNamesSelected = @[@"EditMenuMosaicSelected", @"EditMenuGraffitiBack"];
